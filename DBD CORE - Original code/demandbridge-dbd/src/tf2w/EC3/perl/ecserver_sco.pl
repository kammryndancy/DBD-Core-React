...
#
# 2.4 Modfied by kmc 2005/06/14
#       When writing back to client, script was adding an extra 
#       line feed. This just double spaced HTML pages, but when 
#       returning binary data such as PDFs this prevented them  
...
##########
# Initilization section  2.1
##########
$ec_ver = "2.2S";
$ec_date = "August 08, 2003";
...
sub REAPER {				# takes care of dead children
	...
	$children -- ;
	delete $children{$pid};
	$SIG{CHLD} = \ &REAPER;		# for sysV need it here not above
}
