...
function FMCLinkControl( e, node )
{
    ...
    var topics  = GetHelpControlLinks( node );
    ...
    {
		clientX = FMCGetClientX( window, e );
		clientY = FMCGetClientY( window, e );
		pageX = FMCGetPageX( window, e );
		pageY = FMCGetPageY( window, e );
    }
    ...
    {
        klinkBody.style.top = FMCGetScrollTop( window ) + FMCGetClientHeight( window, false ) - klinkBody.offsetHeight - 5 + "px";
    }
    else
    {
    ...
    {
        klinkBody.style.left = FMCGetScrollLeft( window ) + FMCGetClientWidth( window, false ) - klinkBody.offsetWidth - 5 + "px";
    }
    else
    {
